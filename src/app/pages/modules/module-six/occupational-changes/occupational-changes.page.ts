...
@Component({
  selector: 'app-occupational-changes',
  templateUrl: './occupational-changes.page.html',
  styleUrls: ['occupational-changes.page.scss'],
  standalone: true,
  imports: [
    IonApp,
    IonImg,
...
export class OccupationalChangesPage {}
